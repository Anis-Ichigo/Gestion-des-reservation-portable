...
<div class="main">
  ...
  <div class="menu">
    ...
    <div class="menu__item" id="1-0"><img class="menu__icon" src="livre.svg"/>
      <div class="menu__content"><span class="menu__span">Mes réservations</span><span class="menu__span">Mes réservations</span></div>
    </div></a>
    <a href="profil.php">
    <div class="menu__item" id="0-1"><img class="menu__icon" src="forme-de-l'utilisateur.svg"/>
      <div class="menu__content"><span class="menu__span">Profil</span><span class="menu__span">Profil</span></div>
    </div></a>
    <a href="FAQ.php">
    <div class="menu__item" id="1-1"><img class="menu__icon" src="signe-de-question.svg"/>
      <div class="menu__content"><span class="menu__span">FAQ</span><span class="menu__span">FAQ</span></div>
    </div></a>
    <div class="menu__item" id="0-2"><img class="menu__icon" src="silhouette-de-roue-dentee.svg"/>
      <div class="menu__content"><span class="menu__span">Réglages</span><span class="menu__span">Réglages</span></div>
    </div>
    <a href="deconnexion.php">
    <div class="menu__item" id="1-2"><img class="menu__icon" src="option-de-deconnexion.svg"/>
      <div class="menu__content"><span class="menu__span">Déconnexion</span><span class="menu__span">Déconnexion</span></div>
    </div></a>
